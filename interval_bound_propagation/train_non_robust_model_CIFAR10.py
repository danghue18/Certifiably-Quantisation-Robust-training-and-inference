...
parser.add_argument('--ep_i', default=1/511, type=float, help='epsilon_input')
parser.add_argument('--ep_w', default=1/511, type=float, help='epsilon_weight')
parser.add_argument('--ep_b', default=1/511, type=float, help='epsilon_bias')
...
ep_b = args.ep_b
ep_a = args.ep_a
kappa_schedule = generate_kappa_schedule_CIFAR10()
...
def train(epoch,batch_counter):
    ...
    acc_rob,_ = print_accuracy(net, trainloader, testloader, device, test=True, ep_i = ep_i, 
                                                                                  ep_w=ep_w,
                                                                                  ep_b=ep_b,
                                                                                  ep_a=ep_a)
    ...
    if acc_nor > best_acc:
        ...
        torch.save(state, './checkpoint/CIFAR10/normal1.pth')
        best_acc = acc_nor
        rob_acc = acc_rob
