...
"""Other architure for CIFAR10 dataset"""
# print('==> Preparing data..')
# transform_train = transforms.Compose([
#     transforms.RandomCrop(32, padding=4),
#     transforms.RandomHorizontalFlip(),
...
import time
root = os.getenv('ROOT')
checkpoint_path = os.path.join(root, os.getenv("CHECKPOINT_PATH_ROBUST_MODEL"))
def main():
# Load checkpoint.
    ...
    # time to compute the verification time over 10k MNIST images based on IBP method 
    ...
    path = f'results/MNIST/robust_6_layers_{n_hidden_nodes}_2_255.xlsx'
