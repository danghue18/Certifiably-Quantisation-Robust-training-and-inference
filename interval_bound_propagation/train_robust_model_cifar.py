...
if args.resume:
    ...
    checkpoint = torch.load(r'C:\Users\hueda\Documents\Model_robust_weight_perturbation\interval_bound_propagation\checkpoint\CIFAR10\running_eps_1_255.pth')
...
def train(epoch, batch_counter):
    ...
    if acc_rob > best_acc:
        ...
        torch.save(state, f'./checkpoint/CIFAR10/new_loss_0_5_{ep_w}.pth')
        best_acc = acc_rob
...
if __name__=="__main__":
    ...
    path = f'results/training_phase/CIFAR10/new_loss/0_5_eps_{ep_w}_k_{k}.xlsx'
