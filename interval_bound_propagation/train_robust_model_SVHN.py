...
parser.add_argument('--ep_a', default=0.01, type=float, help='epsilon_activation')
...
if args.resume:
    ...
    checkpoint = torch.load(r'C:\Users\hueda\Documents\Model_robust_weight_perturbation\interval_bound_propagation\checkpoint\SVHN\running_eps_1_255.pth')
...
ep_a = args.ep_a
k = args.k
kappa_schedule = generate_kappa_schedule_SVHN(k)
...
def train(epoch, batch_counter):
    ...
    if acc_rob > best_acc:
        ...
        torch.save(state, f'./checkpoint/SVHN/new_act_old_loss_{ep_a}.pth')
        best_acc = acc_rob  
...
if __name__=="__main__":
    ...
    path = f'results/training_phase/SVHN/old_loss/new_act_eps_{ep_a}_k_{k}.xlsx'
