...
parser.add_argument('--ep_i', default=1/63, type=float, help='epsilon_input')
parser.add_argument('--ep_w', default=2/63, type=float, help='epsilon_weight')
parser.add_argument('--ep_b', default=2/63, type=float, help='epsilon_bias')
parser.add_argument('--ep_a', default=2/63, type=float, help='epsilon_activation')
...
#Model
print('==> Building model..')
net = Small_ConvNet(non_negative = [False, False, False, False], 
...
def train(epoch, batch_counter):
    ...
    if acc_rob > best_acc:
        ...
        torch.save(state, f'./checkpoint/MNIST/robust_CNN_{ep_w}.pth')
        best_acc = acc_rob
