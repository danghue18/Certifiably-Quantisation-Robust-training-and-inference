...
from utils import generate_kappa_schedule_CIFAR10
from utils import generate_epsilon_schedule_CIFAR10
...
parser.add_argument('--ep_i', default=1/2023, type=float, help='epsilon_input')
parser.add_argument('--ep_w', default=1/1023, type=float, help='epsilon_weight')
parser.add_argument('--ep_b', default=1/1023, type=float, help='epsilon_bias')
parser.add_argument('--ep_a', default=1/511, type=float, help='epsilon_activation')
...
# net = Cifar_Small_ConvNet(non_negative = [False, False, False, False], 
...
ep_a = args.ep_a
k = args.k
kappa_schedule = generate_kappa_schedule_CIFAR10(k)
ep_i_schedule = generate_epsilon_schedule_CIFAR10(ep_i)
ep_w_schedule = generate_epsilon_schedule_CIFAR10(ep_w)
ep_b_schedule = generate_epsilon_schedule_CIFAR10(ep_b)
ep_a_schedule = generate_epsilon_schedule_CIFAR10(ep_a)
...
def train(epoch, batch_counter):
    ...
    if acc_rob > best_acc:
        ...
        torch.save(state, f'./checkpoint/CIFAR10/test_robust_{ep_i}_{ep_w}_{ep_a}.pth')
        best_acc = acc_rob
...
if __name__=="__main__":
    ...
    # path = f'results/training_phase/CIFAR10/robust_{ep_i}_{ep_w}_{ep_a}'
