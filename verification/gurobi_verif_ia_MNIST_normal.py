...
if __name__ == '__main__':
    #6 bits
    test_robustness(model_dictionary,net, testloader, epsilon_input=1/64, epsilon_weight=0, epsilon_bias=0, epsilon_activation=0, timeout=1800)
    ...
    #10 bits
    test_robustness(model_dictionary,net, testloader, epsilon_input=1/1024, epsilon_weight=0, epsilon_bias=0, epsilon_activation=0, timeout=1800)
    test_robustness(model_dictionary,net, testloader, epsilon_input=0, epsilon_weight=0, epsilon_bias=0, epsilon_activation=1/512, timeout=1800)
