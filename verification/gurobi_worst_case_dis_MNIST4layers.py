...
# Load checkpoint.
checkpoint_path = f'C:/Users/hueda/Documents/Model_robust_weight_perturbation/interval_bound_propagation/checkpoint/MNIST/normal_4_layers_{n_hidden_nodes}.pth'
checkpoint = torch.load(checkpoint_path)
net.load_state_dict(checkpoint['net'])

#load weight files
model_dictionary = {}
folder_name = f'extracted_params/MNIST/normal_4_layers_{n_hidden_nodes}/'
